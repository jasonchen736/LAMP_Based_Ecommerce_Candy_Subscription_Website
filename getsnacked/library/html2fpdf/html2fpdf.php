...
if (!defined('HTML2PDF_PATH')) define('HTML2PDF_PATH','html2fpdf/');
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH','html2fpdf/font/');
require_once(HTML2PDF_PATH.'fpdf.php');
require_once(HTML2PDF_PATH.'htmltoolkit.php');
